...
public class tst : MonoBehaviour
{
    ...
    public Vector2 boxSize = new Vector3(1.0f, 0.8f); // Kích thước giống OverlapBox
    ...
    private void OnDrawGizmos()
    {
        ...
        // Gizmos.DrawWireSphere(transform.position + new Vector3(lookDirection.x, 0.5f, 0), 1.0f);
    }
}
